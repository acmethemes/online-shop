...
if ( ! function_exists( 'online_shop_get_theme_options' ) ) :
	...
	function online_shop_get_theme_options() {
		...
		if ( is_array( $online_shop_get_theme_options ) ) {
			$cached_theme_options = array_merge( $online_shop_default_theme_options, $online_shop_get_theme_options );
		} else {
			$cached_theme_options = $online_shop_default_theme_options;
		}
